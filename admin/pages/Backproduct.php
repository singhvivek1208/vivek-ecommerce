...
include("../../connection.php");
        ...
        if(isset($_FILES['fs'])){
            ...
            if(isset($_FILES['ls'])){
                ...
                $img_tmp =$_FILES['ls']['tmp_name'];
                 move_uploaded_file($img_tmp,'../../assets/images/'.$imgs);
                }else{
                    echo'no';
                }
                if(isset($_FILES['sec'])){
                    ...
                    $img_tmp =$_FILES['sec']['tmp_name'];
                     move_uploaded_file($img_tmp,'../../assets/images/'.$imges);
                    }else{
                        echo'no';
                    }
            mysqli_query($pro,"INSERT INTO product_img (pr_id,pr_image1, pr_image2,pr_image3) Values ($select,'$img','$imgs','$imges') ");
    }else{
        echo'no';
    ...
    <select name="img" id="">
        <?php 
        $product = mysqli_query($pro,'SELECT * FROM `products`');
